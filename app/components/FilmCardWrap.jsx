...
function FilmCardWrap() {
  ...
  return (
    <>
      {" "}
      <Loader  actClx={responseData ? "" : "active"} />
      <section className={`card-wrap ${responseData ? "active" : ""}`}>
              ...
              >
                <hgroup>
                  ...
                  <p className="card-desc">
                    {genres
                      .filter((e) => {
                        if (path === "/" ? el.genre_ids?.includes(e.id) : el.genres?.map(et => { return et.id})?.includes(e.id)) {
                          return e;
                        } else {
                          return null;
                        }
